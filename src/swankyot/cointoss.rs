...
/// Coin tossing sender.
#[inline]
pub async fn send<C: Channel>(channel: &mut C, seeds: &[Block], p_to: usize) -> Result<Vec<Block>, Error> {
...
#[inline]
pub async fn receive<C: Channel>(channel: &mut C, seeds: &[Block], p_to: usize) -> Result<Vec<Block>, Error> {

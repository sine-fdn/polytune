...
pub struct Circuit {
    ...
    /// The total number of AND gates in the circuit.
    and_gates: usize,
    /// The number of evaluator input bits.
    eval_inputs: usize,
    /// The number of contributor input bits.
...
impl Circuit {
    /// The gates of the circuit, including input gates, XOR/AND/NOT gates and output gates.
    ...
    /// Creates a new circuit from a collection of gates and a collection of output gate indexes.
    ...
    ///
    /// A circuit is invalid in any of the following cases:
    ///   - it contains cycles (by referring to a wire larger than its own index)
    ///   - it does not contain any output gates
    ///   - the specified output gate indexes do not occur in the circuit
    ///   - the number of gates exceeds the maximum supported gates
    ///   - the number of AND gates exceeds the maximum supported AND gates

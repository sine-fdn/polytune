...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_3': Core.Clone.t_Clone t_Commitment
...
let fhaand
  ...
  then
    ...
    in
    match
      Rust_primitives.Hax.Folds.fold_return (Core.Iter.Traits.Collect.f_into_iter #(Core.Iter.Adapters.Filter.t_Filter
            ...
            let h0h1, vi:(Alloc.Vec.t_Vec (bool & bool) Alloc.Alloc.t_Global &
              ...
              Rust_primitives.Hax.Folds.fold_range (mk_usize 0)
                ...
                (fun temp_0_ ll ->
                    ...
                    in
                    let ll:usize = ll in
                    let (sj: bool):bool = Rand.random #bool () in
          ...
          (fun temp_0_ j ->
              ...
              let tmp0, out:(iimpl_951670863_ &
                Core.Result.t_Result (Alloc.Vec.t_Vec (bool & bool) Alloc.Alloc.t_Global)
                  Polytune.Channel.t_Error) =
                Polytune.Channel.recv_vec_from #(bool & bool) #iimpl_951670863_ channel j "haand" l
              in
              let channel:iimpl_951670863_ = tmp0 in
              match
                out
        ...
        Alloc.Vec.from_elem #Polytune.Data_types.t_Share
          (Polytune.Data_types.Share false
              (Polytune.Data_types.Auth
                (Smallvec.impl_17__from_elem #(t_Array
                        (Polytune.Data_types.t_Mac & Polytune.Data_types.t_Key) (mk_usize 2))
                  ...
                  <:
                  Smallvec.t_SmallVec
                  (t_Array (Polytune.Data_types.t_Mac & Polytune.Data_types.t_Key) (mk_usize 2)))
                <:
        ...
        Rust_primitives.Hax.Folds.fold_range (mk_usize 0)
          ...
          (fun temp_0_ ll ->
              ...
              (Alloc.Vec.t_Vec bool Alloc.Alloc.t_Global & Alloc.Vec.t_Vec bool Alloc.Alloc.t_Global &
                Alloc.Vec.t_Vec Polytune.Data_types.t_Share Alloc.Alloc.t_Global))
      in
      let _:Prims.unit = Core.Mem.drop #(Alloc.Vec.t_Vec bool Alloc.Alloc.t_Global) v in
      let _:Prims.unit = Core.Mem.drop #(Alloc.Vec.t_Vec bool Alloc.Alloc.t_Global) z in
                ...
                Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter #(Core.Iter.Adapters.Filter.t_Filter
                      ...
                      (Core.Iter.Traits.Iterator.f_filter #(Core.Ops.Range.t_Range usize)
                          ...
                          (fun k ->
                              ...
                              k <>. i <: bool)
                        <:
                        Core.Iter.Adapters.Filter.t_Filter (Core.Ops.Range.t_Range usize)
                          (usize -> bool))
                    <:
                    Core.Iter.Adapters.Filter.t_Filter (Core.Ops.Range.t_Range usize)
                      (usize -> bool))
                ...
                match
                  Rust_primitives.Hax.Folds.fold_return (Core.Iter.Traits.Collect.f_into_iter #(Core.Iter.Adapters.Take.t_Take
                    ...
                    (fun temp_0_ temp_1_ ->
                        ...
                        in
                        match
                          hash128 ki_xj.Polytune.Data_types._0 <: Core.Result.t_Result u128 t_Error
                        with
                        | Core.Result.Result_Ok hoist7 ->
                          ...
                          in
                          (match
                              hash128 (ki_xj.Polytune.Data_types._0 ^. delta.Polytune.Data_types._0
                                  <:
                                  u128)
                              <:
                                    ...
                                    Rust_primitives.Hax.Monomorphized_update_at.update_at_usize zshares
                                      ...
                                      ({
                                          ...
                                          =
                                          {
                                            ...
                                            Polytune.Data_types._0
                                            =
                                            Rust_primitives.Hax.update_at (zshares.[ ll ]
                                                <:
                                                Polytune.Data_types.t_Share)
                                                .Polytune.Data_types._1
                                                .Polytune.Data_types._0
                                            ...
                                            (t_Array
                                                (Polytune.Data_types.t_Mac &
                                                  Polytune.Data_types.t_Key) (mk_usize 2))
                                          }
                                          <:
                                          Polytune.Data_types.t_Auth
                                        }
                  ...
                  Rust_primitives.Hax.Folds.fold_range (mk_usize 0)
                    ...
                    (fun temp_0_ ll ->
                        ...
                        (Alloc.Vec.t_Vec t_Commitment Alloc.Alloc.t_Global &
                          Alloc.Vec.t_Vec u128 Alloc.Alloc.t_Global))
                in
                let _:Prims.unit = Core.Mem.drop #(Alloc.Vec.t_Vec u128 Alloc.Alloc.t_Global) phi in
                let _:Prims.unit =
                  Core.Mem.drop #(Alloc.Vec.t_Vec (Alloc.Vec.t_Vec u128 Alloc.Alloc.t_Global)
                        Alloc.Alloc.t_Global)
                    ki_xj_phi
                in
                let tmp0, out:(iimpl_951670863_ &
